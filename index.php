...
<html lang="en">
    <head>
        ...
        <title>Nestor's portfolio</title>
        <!-- Favicon-->
    ...
    <body id="page-top">
        ...
        <header class="masthead bg-prim bg-dark pt-13 text-white text-center" id="acceuil">
            <div class="container d-flex align-items-center flex-column  ">
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Programmer - Graphic designer - Maintainer - Electronic</p>
            </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal1">
                            ...
                            <embed src="assets/video/video3.mp4" autostart="false" height="50%"  width="100%"/>  
                        </div>
                        <h3 class="text-center">Tadagbé</h3>
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal2">
                            ...
                            <embed src="assets/video/video1.mp4" autostart="false" height="50%"  width="100%"/>  
                        </div>
                        <h3 class="text-center">Covid Filter Part1</h3>
...
disinfection.</details>
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal3">
                            ...
                            <embed src="assets/video/video2.mp4" autostart="false" height="50%"  width="100%"/>  
                        </div>
                        <h3 class="text-center">Covid Filter Part2</h3>
                        <details>Covid Filter is an electronic project designed under artificial intelligence to serve maximum protection
for the population. This project consists in ensuring the scope of the mask or not by a robot, temperature control and a tunnel of
disinfection.</details> 
                    </div>
        ...
        <section class="page-section portfolio" id="skills">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                    <span>HTML5</span> <span class="pull-right">75%</span>
                    ...
                    <div class="progress mb-5">
                      <div class="progress-bar bg-secondary" role="progressbar" style="width: 50%" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
</div>
...
<span>Bootstrap</span> <span class="pull-right">70%</span>
                    ...
                    <span>Symfony</span> <span class="pull-right">60%</span>
                    <div class="progress mb-5">
                    ...
                    <span>OOP</span> <span class="pull-right">50%</span>
                    <div class="progress mb-5">
                      <div class="progress-bar bg-info" role="progressbar" style="width: 70%" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
</div>
...
<span>Photoshop</span> <span class="pull-right">80%</span>
                    ...
                    <span>Corel Draw</span> <span class="pull-right">60%</span>
                    <div class="progress mb-5">
                      <div class="progress-bar" role="progressbar" style="width: 80%" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>

                    <span>Electronics & Arduino</span> <span class="pull-right">70%</span>
                    <div class="progress mb-5">
                      <div class="progress-bar bg-success" role="progressbar" style="width: 65%" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
</div>
        ...
        <section class="page-section bg-dark text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ms-auto"><p class="lead">I am Nestor Kenoude Amouzoun, a computer engineer. In my primary school, I liked electronics a lot before I went to university where I discovered the world of programming which attracted me well.</p></div>
                    <div class="col-lg-4 me-auto"><p class="lead">In short, I am passionate about the computer world and many of its derivatives such as: electronics, maintenance, programming, graphics, networking, ... .</p></div>
                </div>
                <!-- About Section Button-->
                <div class="text-center mt-4">
                    <a class="btn btn-xl btn-outline-light" download href="assets/img/portfolio/NestorCV.pdf">
        ...
        <section class="page-section" id="contact">
           ...
           <!-- <h6 class="text-center">ehome229@gmail.com</h6>-->
            <a href="mailto:ehome229@gmail.com" class="btn btn-outline-dark  mx-auto rounded align-items-center"> <i class="fab fa-fw fa-"></i> Send me mail from Here</a>
            </div>
        </section>
        <!-- Footer-->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        ...
                        <a class="btn btn-outline-light btn-social mx-1" href="https://web.facebook.com/nestorkenoude.amouzoun"><i class="fab fa-fw fa-facebook-f"></i></a>
        ...
        <script>
    var url = 'https://wati-integration-service.clare.ai/ShopifyWidget/shopifyWidget.js?73483';
